  ...
  return (
    <div className="relative z-40">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="grid">
          <p className="col-span-full self-start font-bold text-center text-base text-green-500 drop-shadow-2xl mb-40">
            MIGRACION DE EMPRENDIMIENTOS AL MUNDO DIGITAL AL ALCANCE DE TODOS
          </p>
          <p className="col-span-full z-10 font-bold text-white text-center text-7xl mb-40 leading-normal">
